...
function RelatedListingsConst({category, type=null, locations, dir_categories, listingId}) {
  return (
    <Client>
              ...
              <RelatedByTaxSplide exClass='my-2' cardWidth={150} cardExClass={'xs'} titleComp={<SectionHeader exClass='px-3 mb-2'  title={`More ${type}s`} subitle={`Other ${type}s you may like`}/>} type={type} nextUpdater random  exclude={listingId}/>
