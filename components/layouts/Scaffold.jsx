  ...
  return (<>
    <div className="container-fluid p-0">
        <div className="row flex-nowrap">
            ...
            <div className="md-sticky col p-2 flex-grow-0 d-none d-md-block right_view" style={{width: '295px', minWidth: '295px', top: '0px'}}>
                <Activity/>
            </div>
        </div>
    </div>
    <Client>
        ...
        <div style={{width: '300px'}} id="mobile_news" className="menu menu-box-right d-block d-md-none rounded-16 bg-theme">
            <Activity/>
        </div>
    </Client>
    </>
