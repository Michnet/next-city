...
function ListingCard({listing}) {
    let {id, title, short_desc, event_date,type, page_views, rating, acf, locations, level, ticket_min_price_html, xtra_large_thumb, gallery, slug} = listing;

    return <Link href={`/${type}s/${slug}`} className="mx-3" /* data-menu="menu-reserve" */>
