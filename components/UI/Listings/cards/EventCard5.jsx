...
const EventCard5 = ({listing, width=300, height=200, exClass=''}) => {
    ...
    <div className={`card card-style round-medium shadow-huge top-30 m-0 event_card_5 ${exClass}`} style={{width: width, height: height}}>
            ...
            <div className={`card-overlay _grayScale opacity-50`} style={{background: `url(${xtra_large_thumb})`}}/>
            <div className={`card-overlay opacity-70 ${color ? '' : `bg-${randColor}-dark`}`} style={{background: color, backdropFilter: 'blur(3px)'}}/>
