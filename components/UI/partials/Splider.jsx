...
const Splider = ({children, options={}, height=null, autoHeight=true, showDots=false, exClass='', type= 'loop' }) => {
    let optObj = {snap: true, arrows: true, pagination: false,  breakpoints: { 600: { arrows: false, pagination: true}, }, pauseOnHover: true, autoWidth: true, height: height, type:type, autoHeight: autoHeight,  pagination: showDots, wheel: false, ...options}
    return (
