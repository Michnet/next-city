...
const ProductCard = ({product, user, horizontal=false, mini=true, sized}) => {
  ...
  <div className={`card card-style m-0 bg-theme pdt-card d-flex ${mini ? '_mini' : ''} ${sized ? '_sized' : ''} ${horizontal ? 'flex-row' : 'flex-col'}`}>
