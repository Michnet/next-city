...
import EventCard6 from '../../components/UI/Listings/cards/EventCard6';
import { advancedFetchListingsUrl, fetcher } from '@/helpers/rest';
import { generateTempArray } from '@/helpers/universal';
import ListingTimeline from '../../components/UI/lists/timelines/ListingTimeline';
...
const SearchFilter = dynamic(() => import('../../components/UI/search/SearchFilter'));
