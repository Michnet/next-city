...
import SearchForm1 from "../../components/UI/search/SearchForm1";
//import Splash from "../UI/Splash";
import SnackBar from "../../components/UI/partials/SnackBar";
import UserSideMenu from "../../components/UI/user/UserSideMenu";
import UISettings from "../../components/layouts/UISettings";
import { ParallaxScrollProvider } from '@/contexts/ParallaxContext';
import { siteColorObjs } from '@/helpers/base';
//import { getSession } from "next-auth/react";
import { useSearchParams } from 'next/navigation'
import Scaffold from './appScaffold';
...
function LayoutConst({ children, headerTitle, settings}) {
  ...
  console.log('marr', searchParams.values());
