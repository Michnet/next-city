...
export async function getStaticPaths() {
    const res = await fetch(fetchIdsUrl({type: 'job_listing', per_page: 10, page: 1, listing_type:'special-sale', slugs: true}));
    ...
    return {
      props: {
        ...
        settings : {
            ...
            noFooter: true,
            pageClass: '_listing _special-sale',
            mMenu: 'show',
            mMenuContent:{
