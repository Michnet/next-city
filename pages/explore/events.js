          ...
          <div className="container-fluid mw-100 p-0">
            ...
            <div className="explore_content col minw-0 p-md-2 p-0">
              ...
              {!query || eventDate !== 'this-week' && <div className="inner_section mt-20">
                    <ActivityCarousel skeletonHeight={200} skeletonWidth={270} thumbsize={'xtra_large_thumb,thumbnail'} cardWidth={270} gap={15} exCardClass={'_mini'} eventDate={'this-week'} title={'Happening this week'}  iconClass={'fas fa-calendar-week'} limit={10} cardType={5} exClass={'px-0'} height={210} />
              </div>}
